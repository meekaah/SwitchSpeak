...
{
    public class ClientListEntry : IDump, INotifyPropertyChanged
    {
        #region Properties
        ...
        private bool? isClientTalking;
        public bool? IsClientTalking
        {
            get
            {
                return isClientTalking;
            }
            set
            {
                isClientTalking = value;
                OnPropertyChanged("IsClientTalking");
            }
        }
